...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.whileHeld(new CommandDriveStraightTo(12, .25));
        ...
        SmartDashboard.putData("CommandDriveStraightTo: Preset1", new CommandDriveStraightTo(0, 0.1));
        SmartDashboard.putData("CommandDriveWithJoystick", new CommandDriveWithJoystick());
